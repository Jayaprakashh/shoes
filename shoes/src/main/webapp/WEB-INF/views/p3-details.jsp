...
<div class="container">
   ...
   <div class="col-xs-4 item-photo">
                    <img style="max-width:100%;" src="./resources/images/p5.jpg" />
                </div>
                <div class="col-xs-5" style="border:0px solid gray">
                     
                    <h3>Men Shoe Light Blue </h3>    
                    ...
                    <h3 style="margin-top:0px;">2500</h3>
                    ...
                    <div class="section" style="padding-bottom:5px;">
                        ...
                        <br><br><br> <div class="attr2">9</div>
                         <br><br><br> <div class="attr2">8</div>
                          <br><br><br> <div class="attr2">7</div>
                         <br><br><br> <div class="attr2">6</div>
                        </div> 
                    </div>   
