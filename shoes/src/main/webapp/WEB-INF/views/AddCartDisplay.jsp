		...
		<div class="item-container">	
			<div class="container">	
				<div class="col-md-12">
                    ...
                    <br>
						<center>
							...
							<img id="item-display" src="./resources/uploads/shoes/${shoe.image}" alt="" width="150" height="150"></img>
						</center>
					</div>
				...
				<div class="product-title">${shoe.name}</div>
					...
					<div class="product-desc">${shoe.p_description}</div>
					<div class="product-rating"><i class="fa fa-star gold"></i> <i class="fa fa-star gold"></i> <i class="fa fa-star gold"></i> <i class="fa fa-star gold"></i> <i class="fa fa-star-o"></i> </div>
					<hr>
					<form action="productdetails">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="hidden"  name="prodid" value="${shoe.id}"  onkeyup="sum();"/><br><br>
					ProductPrice:&nbsp;&nbsp;&nbsp;
					<input type="text" id="txt1" name="prodprice" value="${shoe.price}" readonly onkeyup="sum();"/><br><br>
